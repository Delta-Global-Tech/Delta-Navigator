...
const ESTADOS_INFO: { [key: string]: string } = {
  ac: 'Acre',
  al: 'Alagoas',
  ap: 'Amapá',
  am: 'Amazonas',
...
export function MapaBrasilSVG({ onStateSelect }: { onStateSelect?: (state: string) => void }) {
  ...
  useEffect(() => {
    const loadMapData = async () => {
      try {
        ...
        const estadosMap: MapState = {};
        data.forEach((cidade: any) => {
          const estadoKey = cidade.estado?.toLowerCase() || '';
          if (!estadosMap[estadoKey]) {
            estadosMap[estadoKey] = {
              estado: estadoKey,
          ...
          estadosMap[estadoKey].quantidade_clientes += cidade.quantidade_clientes || 0;
          estadosMap[estadoKey].total_credito_liberado += cidade.total_credito_liberado || 0;
        });

        // Calcula crédito médio
        Object.keys(estadosMap).forEach(key => {
          if (estadosMap[key].quantidade_clientes > 0) {
            estadosMap[key].credito_medio = 
              estadosMap[key].total_credito_liberado / estadosMap[key].quantidade_clientes;
          }
        });

        setMapData(estadosMap);
        setError(null);
      } catch (err) {
  ...
  const getStateColor = (stateCode: string) => {
    ...
    if (!data) return 'rgba(196, 138, 63, 0.1)'; // Sem dados - cinza claro
    
    const maxClientes = Math.max(...Object.values(mapData).map(d => d.quantidade_clientes || 0), 1);
    const normalizado = (data.quantidade_clientes || 0) / maxClientes;
    
    // Gradiente de cor DOURADA (quanto mais clientes, mais intenso o dourado)
    if (normalizado === 0) return 'rgba(196, 138, 63, 0.1)';
    if (normalizado < 0.25) return 'rgba(196, 138, 63, 0.3)';
    if (normalizado < 0.5) return 'rgba(196, 138, 63, 0.5)';
    if (normalizado < 0.75) return 'rgba(196, 138, 63, 0.7)';
    return '#C48A3F'; // Dourado profundo
  };

  const selectedData = mapData[selectedState];

  if (loading) {
    return (
      <div className="flex items-center justify-center h-96">
        <Loader className="animate-spin mr-3" style={{ color: '#C48A3F' }} />
        <span style={{ color: '#C48A3F' }} className="text-lg font-semibold">Carregando mapa...</span>
      </div>
    );
  }
    ...
    return (
      ...
      >
        <div className="flex items-start gap-3">
          ...
          <div>
            <h3 style={{ color: '#FCA5A5' }} className="font-semibold text-lg">Erro ao carregar mapa</h3>
            <p style={{ color: '#FECACA' }} className="text-sm mt-1">{error}</p>
          </div>
        </div>
      </Card>
    );
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <div className="lg:col-span-2">
        <Card 
          ...
          style={{ background: 'rgba(6, 22, 43, 0.9)', borderColor: '#C48A3F' }}
        >
          <div className="flex justify-center p-4 rounded-lg" style={{ background: 'rgba(196, 138, 63, 0.05)' }}>
            <svg 
              id="map" 
            ...
            >
              <g className="model-davi">
                {/* Estados SVG - Vou incluir os principais */}
                
                {/* BAHIA */}
                <g 
                  id="state_ba" 
                  className="state cursor-pointer group" 
                  data-state="ba"
                ...
                >
                  <path 
                    ...
                    fill={hoveredState === 'ba' ? '#0288d1' : getStateColor('ba')}
                  ...
                  <text 
                    ...
                    className="label_icon_state fill-white font-bold text-xs" 
                    x="365" 
                    y="216"
                  >
                    BA
                ...
                >
                  <path 
                    id="shape_mg" 
                    className="shape transition-all duration-300" 
                    fill={hoveredState === 'mg' ? '#0288d1' : getStateColor('mg')}
                ...
                >
                  <path 
                    id="shape_sp" 
                    className="shape transition-all duration-300" 
                    fill={hoveredState === 'sp' ? '#0288d1' : getStateColor('sp')}
                ...
                >
                  <path 
                    id="shape_rj" 
                    className="shape transition-all duration-300" 
                    fill={hoveredState === 'rj' ? '#0288d1' : getStateColor('rj')}
                  ...
                  <circle 
                    id="icon_rj" 
                    className="icon_state fill-white" 
                    r="12" 
                    cx="364" 
                    cy="339"
                  />
                  <text 
                    ...
                    className="label_icon_state fill-gray-800 font-bold text-xs" 
                    x="357" 
                    y="343"
                  >
                    RJ
                ...
                >
                  <path 
                    id="shape_se" 
                    className="shape transition-all duration-300" 
                    fill={hoveredState === 'se' ? '#0288d1' : getStateColor('se')}
                ...
                >
                  <path 
                    id="shape_pe" 
                    className="shape transition-all duration-300" 
                    fill={hoveredState === 'pe' ? '#0288d1' : getStateColor('pe')}
                ...
                >
                  <path 
                    id="shape_al" 
                    className="shape transition-all duration-300" 
                    fill={hoveredState === 'al' ? '#0288d1' : getStateColor('al')}
                ...
                >
                  <path 
                    id="shape_am" 
                    className="shape transition-all duration-300" 
                    fill={hoveredState === 'am' ? '#0288d1' : getStateColor('am')}
                ...
                >
                  <path 
                    id="shape_pa" 
                    className="shape transition-all duration-300" 
                    fill={hoveredState === 'pa' ? '#0288d1' : getStateColor('pa')}
                ...
                >
                  <path 
                    id="shape_mt" 
                    className="shape transition-all duration-300" 
                    fill={hoveredState === 'mt' ? '#0288d1' : getStateColor('mt')}
                ...
                >
                  <path 
                    id="shape_ro" 
                    className="shape transition-all duration-300" 
                    fill={hoveredState === 'ro' ? '#0288d1' : getStateColor('ro')}
                ...
                >
                  <path 
                    id="shape_ac" 
                    className="shape transition-all duration-300" 
                    fill={hoveredState === 'ac' ? '#0288d1' : getStateColor('ac')}
                ...
                >
                  <path 
                    id="shape_ap" 
                    className="shape transition-all duration-300" 
                    fill={hoveredState === 'ap' ? '#0288d1' : getStateColor('ap')}
                ...
                >
                  <path 
                    id="shape_rs" 
                    className="shape transition-all duration-300" 
                    fill={hoveredState === 'rs' ? '#0288d1' : getStateColor('rs')}
                ...
                >
                  <path 
                    id="shape_sc" 
                    className="shape transition-all duration-300" 
                    fill={hoveredState === 'sc' ? '#0288d1' : getStateColor('sc')}
                ...
                >
                  <path 
                    id="shape_pr" 
                    className="shape transition-all duration-300" 
                    fill={hoveredState === 'pr' ? '#0288d1' : getStateColor('pr')}
                ...
                >
                  <path 
                    id="shape_ms" 
                    className="shape transition-all duration-300" 
                    fill={hoveredState === 'ms' ? '#0288d1' : getStateColor('ms')}
                ...
                >
                  <path 
                    id="shape_go" 
                    className="shape transition-all duration-300" 
                    fill={hoveredState === 'go' ? '#0288d1' : getStateColor('go')}
                ...
                >
                  <path 
                    id="shape_es" 
                    className="shape transition-all duration-300" 
                    fill={hoveredState === 'es' ? '#0288d1' : getStateColor('es')}
                ...
                >
                  <path 
                    id="shape_pi" 
                    className="shape transition-all duration-300" 
                    fill={hoveredState === 'pi' ? '#0288d1' : getStateColor('pi')}
                ...
                >
                  <path 
                    id="shape_ce" 
                    className="shape transition-all duration-300" 
                    fill={hoveredState === 'ce' ? '#0288d1' : getStateColor('ce')}
                ...
                >
                  <path 
                    id="shape_rr" 
                    className="shape transition-all duration-300" 
                    fill={hoveredState === 'rr' ? '#0288d1' : getStateColor('rr')}
                ...
                >
                  <path 
                    id="shape_to" 
                    className="shape transition-all duration-300" 
                    fill={hoveredState === 'to' ? '#0288d1' : getStateColor('to')}
                ...
                >
                  <path 
                    id="shape_ma" 
                    className="shape transition-all duration-300" 
                    fill={hoveredState === 'ma' ? '#0288d1' : getStateColor('ma')}
                ...
                >
                  <path 
                    id="shape_rn" 
                    className="shape transition-all duration-300" 
                    fill={hoveredState === 'rn' ? '#0288d1' : getStateColor('rn')}
                ...
                >
                  <path 
                    id="shape_pb" 
                    className="shape transition-all duration-300" 
                    fill={hoveredState === 'pb' ? '#0288d1' : getStateColor('pb')}
          ...
          {/* Legenda de cores */}
          <div 
            className="mt-4 p-4 rounded border-2 backdrop-blur-sm"
            style={{ 
              background: 'rgba(15, 23, 41, 0.8)',
              borderColor: 'rgba(212, 165, 116, 0.3)'
            }}
          >
            <p style={{ color: '#D4A574' }} className="text-sm font-bold mb-3 uppercase tracking-wide">📊 Intensidade de Clientes:</p>
            <div className="flex gap-3 items-center justify-start flex-wrap">
              <div className="flex items-center gap-2">
                <div className="w-5 h-5 rounded" style={{ backgroundColor: 'rgba(212, 165, 116, 0.1)', border: '1px solid rgba(212, 165, 116, 0.5)' }}></div>
                <span style={{ color: '#D4A574' }} className="text-xs font-semibold">Sem dados</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-5 h-5 rounded" style={{ backgroundColor: 'rgba(212, 165, 116, 0.3)' }}></div>
                <span style={{ color: '#D4A574' }} className="text-xs font-semibold">Baixo</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-5 h-5 rounded" style={{ backgroundColor: 'rgba(212, 165, 116, 0.5)' }}></div>
                <span style={{ color: '#D4A574' }} className="text-xs font-semibold">Médio</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-5 h-5 rounded" style={{ backgroundColor: 'rgba(212, 165, 116, 0.7)' }}></div>
                <span style={{ color: '#D4A574' }} className="text-xs font-semibold">Alto</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-5 h-5 rounded" style={{ backgroundColor: '#B07A2E' }}></div>
                <span style={{ color: '#D4A574' }} className="text-xs font-semibold">Muito Alto</span>
              </div>
            </div>
          </div>
        </Card>
      ...
      <div className="lg:col-span-1">
        <Card 
          className="p-8 sticky top-4 border-2 backdrop-blur-sm"
          style={{ background: 'rgba(6, 22, 43, 0.9)', borderColor: '#C48A3F' }}
        >
          {/* Seletor de Estados */}
          <div className="mb-8">
            <label style={{ color: '#C48A3F' }} className="block text-sm font-bold mb-3 tracking-wide">
              📍 Selecione um Estado:
            </label>
            <select
              value={selectedState}
              onChange={(e) => setSelectedState(e.target.value)}
              className="w-full p-3 border-2 rounded-lg bg-gray-900 text-white font-medium focus:ring-2 focus:outline-none transition-all"
              style={{ 
                borderColor: '#C48A3F',
                color: '#FFF',
                backgroundColor: 'rgba(6, 22, 43, 0.95)'
              }}
              onFocus={(e) => e.target.style.borderColor = '#C48A3F'}
              onBlur={(e) => e.target.style.borderColor = '#C48A3F'}
            >
              {Object.entries(ESTADOS_INFO).map(([code, nome]) => (
                <option key={code} value={code} style={{ backgroundColor: '#0a1f2e', color: '#FFF' }}>
                  {nome}
                </option>
              ))}
            </select>
          ...
          {selectedData ? (
            <div className="space-y-5">
              <div className="pb-5 border-b" style={{ borderColor: 'rgba(196, 138, 63, 0.3)' }}>
                <h3 style={{ color: '#C48A3F', fontSize: '1.5rem' }} className="font-bold mb-2">
                  {ESTADOS_INFO[selectedState]}
                </h3>
                <p className="text-xs text-gray-400 uppercase tracking-widest">Estado: {selectedState.toUpperCase()}</p>
              </div>

              <div className="space-y-4">
                {/* Quantidade de Clientes */}
                <div 
                  className="p-5 rounded-lg border-2 backdrop-blur-sm"
                  style={{ 
                    background: 'rgba(196, 138, 63, 0.1)',
                    borderColor: '#C48A3F'
                  }}
                >
                  <p style={{ color: '#C48A3F' }} className="text-xs font-bold uppercase tracking-wider mb-2">👥 Clientes</p>
                  <p style={{ color: '#FFF', fontSize: '1.75rem' }} className="font-bold">
                    {selectedData.quantidade_clientes.toLocaleString('pt-BR')}
                  </p>
                </div>
                ...
                >
                  <p style={{ color: '#C48A3F' }} className="text-xs font-bold uppercase tracking-wider mb-2">💰 Total de Crédito</p>
                  <p style={{ color: '#FFF', fontSize: '1.25rem' }} className="font-bold">
                    R$ {(selectedData.total_credito_liberado || 0).toLocaleString('pt-BR', {
                ...
                >
                  <p style={{ color: '#C48A3F' }} className="text-xs font-bold uppercase tracking-wider mb-2">⚡ Crédito Médio</p>
                  <p style={{ color: '#FFF', fontSize: '1.25rem' }} className="font-bold">
                    R$ {(selectedData.credito_medio || 0).toLocaleString('pt-BR', {
                      minimumFractionDigits: 2,
                      maximumFractionDigits: 2,
                    })}
                  </p>
              ...
              {/* Info Box */}
              <div className="p-4 rounded-lg text-xs text-gray-300" style={{ background: 'rgba(196, 138, 63, 0.08)' }}>
                <p>💡 <strong style={{ color: '#C48A3F' }}>Dica:</strong> Clique em um estado no mapa para visualizar seus dados ou use o seletor abaixo.</p>
              </div>
            </div>
          ) : (
            <div className="text-center py-12">
              <p className="text-gray-400 text-sm">Nenhum dado disponível para este estado</p>
            </div>
          )}
        </Card>
      </div>
